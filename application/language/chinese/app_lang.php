...
/**
 * App Language File (Simplified Chinese)
 *
...
$lang['welcome_h1'] = '欢迎来到 CiSkeleton！';
$lang['welcome_p1'] = '您正在查看由 CiSkeleton 动态生成的页面。';
$lang['welcome_p2'] = '如果您想编辑此页面，您可以在以下位置找到它：';
$lang['welcome_p3'] = '此页面的相应控制器位于以下位置：';
$lang['welcome_p4'] = '如果您是第一次探索 CiSkeleton，请从阅读 <a href="%s" target="_blank">用户指南</a> 开始。';
$lang['welcome_footer'] = '页面在 <strong>%s</strong> 秒内呈现。CodeIgniter <strong>v%s</strong>。Skeleton <strong>v%s</strong>。';
