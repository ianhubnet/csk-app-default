...
// Open form.
echo form_open('', 'class="row" id="add-page" role="form" rel="persist" autocomplete="off"', $hidden);
?>
	...
	<div class="col-12 col-lg-3">
		...
		<div class="card card-sm mt-3">
			<a href="#" class="card-header text-center border-bottom-0 bg-body-secondary"
			data-bs-toggle="collapse" data-bs-target="#page-metadata">
			...
			<div class="card-body">
				...
				<div class="mt-1">
					...
					echo form_dropdown('enabled', array(
						...
						'class' => error_class('enabled', 'form-select form-select-sm')
					));
				...
				<div class="mt-1 mb-3">
					...
					echo form_dropdown('privacy', array(
						...
						'class' => error_class('privacy', 'form-select form-select-sm')
					));
