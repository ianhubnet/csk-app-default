 ...
 */
abstract class CI_DB_query_builder extends KB_DB_driver {
	...
	/**
	 * QB Cached 'MAX', 'MIN', 'AVG', 'SUM'.
	 *
	 * @var array
	 */
	protected $qb_min_max_types;
	...
	protected function _max_min_avg_sum($select = '', $alias = '', $type = 'MAX')
	{
		...
		isset($this->qb_min_max_types) OR $this->qb_min_max_types = array('MAX', 'MIN', 'AVG', 'SUM');

		$type = strtoupper($type);

		if ( ! in_array($type, $this->qb_min_max_types))
		{
