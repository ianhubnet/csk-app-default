...
if ( ! function_exists('password_get_info'))
{
	 ...
	 * password_get_info()
	 *
	 * @link    https://php.net/password_get_info
	 * @param   string  $hash
	 * @return  array
	 */
...
if ( ! function_exists('password_hash'))
{
	 ...
	 * password_hash()
	 *
	 * @link    https://php.net/password_hash
...
if ( ! function_exists('password_needs_rehash'))
{
	 ...
	 *
	 * @link    https://php.net/password_needs_rehash
	 * @param   string  $hash
	 * @param   int $algo
	 * @param   array   $options
	 * @return  bool
...
if ( ! function_exists('password_verify'))
{
	 ...
	 * password_verify()
	 *
	 * @link    https://php.net/password_verify
	 * @param   string  $password
	 * @param   string  $hash
	 * @return  bool
	 */
