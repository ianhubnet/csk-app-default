...
defined('IMAGETYPE_GIF')  OR define('IMAGETYPE_GIF', 1);
defined('IMAGETYPE_JPEG') OR define('IMAGETYPE_JPEG', 2);
defined('IMAGETYPE_PNG')  OR define('IMAGETYPE_PNG', 3);
...
class CI_Image_lib
{
	...
	public function image_create_gd($path = '', $image_type = '')
	{
		...
		switch ($image_type)
		{
			...
			case IMAGETYPE_JPEG:
				...
				{
					$this->set_error(array('imglib_unsupported_imagecreate', 'imglib_ext_not_supported'), 'JPG');
					return false;
				}
			...
			case IMAGETYPE_PNG:
				...
				{
					$this->set_error(array('imglib_unsupported_imagecreate', 'imglib_ext_not_supported'), 'PNG');
					return false;
				}
			...
			case IMAGETYPE_WEBP:
				...
				{
					$this->set_error(array('imglib_unsupported_imagecreate', 'imglib_ext_not_supported'), 'WEBP');
					return false;
				}
	...
	public function get_image_properties($path = '', $return = false)
	{
		...
		$types = array(IMAGETYPE_GIF => 'gif', IMAGETYPE_JPEG => 'jpeg', IMAGETYPE_PNG => 'png', IMAGETYPE_WEBP => 'webp');
	...
	public function set_error($msg, $arg = null)
	{
		...
		if (is_array($msg))
		{
			foreach ($msg as $val)
			{
				...
				$this->error_msg[] = ($arg === null) ? $msg : (is_array($arg) ? vsprintf($msg, $arg) : sprintf($msg, $arg));
