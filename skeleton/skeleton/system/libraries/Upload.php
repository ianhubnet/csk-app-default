...
class CI_Upload
{
	...
	/**
	 * Cached allowed types to prevent creating arrays on check.
	 *
	 * @var array
	 */
	protected $allowed_filetype;
	...
	public function set_filename($path, $filename)
	{
		...
		if ($this->overwrite === true OR ! is_file($path.$filename))
		{
			return $filename;
		}
	...
	public function is_allowed_filetype($ignore_mime = false)
	{
		...
		isset($this->allowed_filetype) OR $this->allowed_filetype = array('gif', 'jpg', 'jpeg', 'jpe', 'png', 'webp');
		if (in_array($ext, $this->allowed_filetype, true) && @getimagesize($this->file_temp) === false)
		{
			return false;
		}
