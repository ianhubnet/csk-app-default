...
if ( ! function_exists('mailto'))
{
	...
	function mailto($email, $title = '', $attributes = '')
	{
		...
		return '<a href="mailto:'.$email.'"'.array_to_attr($attributes).'>'.$title.'</a>';
	}
}
...
if ( ! function_exists('redirect'))
{
	...
	function redirect($uri = '', $method = 'auto', $code = null)
	{
		...
		if (is_ajax() OR $method === 'js')
		{
			echo '<script>window.location = "'.html_escape($uri).'";</script>';
			exit;
		}
		...
		// The default header specifies the content type as HTML, which
		// requires certain elements to be considered valid.
		// No content is included, so use a content type which does
		// not require any.
