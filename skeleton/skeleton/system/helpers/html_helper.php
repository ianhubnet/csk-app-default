...
if ( ! function_exists('heading'))
{
	...
	{
		return '<h'.$h.array_to_attr($attributes).'>'.$data.'</h'.$h.'>';
	}
}
...
if ( ! function_exists('img'))
{
	...
	function img($src = '', $index_page = false, $attributes = '')
	{
		...
		return $img.array_to_attr($attributes).' />';
	}
}
...
if ( ! function_exists('doctype'))
{
	...
	function doctype($type = 'html5')
	{
		...
		{
			if (is_file(KBPATH.'config/doctypes.php'))
			{
				include(KBPATH.'config/doctypes.php');
			}
