...
defined('FILTER_VALIDATE_BOOL') OR define('FILTER_VALIDATE_BOOL', FILTER_VALIDATE_BOOLEAN);
...
if ( ! function_exists('hash_hmac')) {
	...
	function hash_hmac($algo, $data, $key, $binary = false) {
		$hmac  = false;
		$packs = array('md5' => 'H32', 'sha1' => 'H40', 'sha256' => 'H40');
		...
		return $binary ? pack($pack, $hmac) : $hmac;
	}
}
...
if ( ! function_exists('time_safe_equals')) {
	/**
	 * A timing safe equals comparison.
	 *
	 * Checks whether two strings are equal without leaking information
	 * about the contents of "known_string" via the execution time.
	 *
	 * @param 	string 	$known_str 	The known string that must be kept secret.
	 * @param 	string 	$user_str 	The user-supplied string to compare against.
	 * @return 	Returns true when the two strings are equal, false otherwise.
	 */
	function time_safe_equals($known_str, $user_str) {
		return hash_equals($known_str, $user_str);
	}
}
...
if ( ! function_exists('array_replace_recursive')) {
	 ...
	 *
	 * @see https://php.net/manual/en/function.array-replace-recursive.php#109390
	 *
...
if ( ! function_exists('str_starts_with'))
{
	...
	{
		return ('' === $needle) ? true :  0 === strpos($haystack, $needle);
	}
}
...
{
	/**
	 * Performs a case-insensitive str_starts_with.
	 *
	 * @return 	str_starts_with()
	 */
	function str_istarts_with($haystack, $needle)
	{
		return str_starts_with(strtolower($haystack), strtolower($haystack));
	}
}
...
{
	/**
	 * Performs a case-sensitive check indicating if the haystach begins
	 * with any of the given needles.
	 *
	 * @param 	string 	$haystack
	 * @param 	array 	$needles
	 * @return 	bool
	 */
	function str_starts_with_any($haystack, array $needles)
	{
...
{
	/**
	 * Performs a case-insensitive str_ends_with.
	 *
	 * @return 	str_ends_with()
	 */
	function str_iends_with($haystack, $needle)
	{
		return str_ends_with(strtolower($haystack), strtolower($haystack));
	}
}
...
{
	/**
	 * Performs a case-sensitive check indicating if the haystach ends
	 * with any of the given needles.
	 *
	 * @param 	string 	$haystack
	 * @param 	array 	$needles
	 * @return 	bool
	 */
	function str_ends_with_any($haystack, array $needles)
	{
		foreach ($needles as $needle)
		{
...
{
	/**
	 * Performs a case-insensitive str_contains.
	 *
	 * @return 	str_contains()
	 */
	function str_icontains($haystack, $needle)
	{
		return str_contains(strtolower($haystack), strtolower($haystack));
	}
}
...
{
	/**
	 * Performs a case-sensitive check indicating if the haystach contains
...
if ( ! function_exists('array_key_first'))
{
	 ...
	 *
	 * Gets the first key of the given array without affecting
	 * the internal array pointer.
	 *
	 * @param 	array 	$array 	An array
	 * @return 	mixed 	The first key if found, else null.
	 */
...
if ( ! function_exists('array_key_last'))
{
	 ...
	 *
	 * Gets the last  key of the given array without affecting
	 * the internal array pointer.
	 *
	 * @param 	array 	$array 	An array
	 * @return 	mixed 	The last key if found, else null.
	 */
